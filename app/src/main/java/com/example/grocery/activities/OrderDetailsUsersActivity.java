...
public class OrderDetailsUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get values through intent
        Intent intent = getIntent();
        orderTo = intent.getStringExtra("orderTo");//order To contains uid of the shop where we placed ordered
        ...
        writeReviewBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent1.putExtra("shopUid",orderTo); //to writ review to a shop ,we must have uid of shop
        ...
        ref.child(orderTo).child("Orders").child(orderId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        String formatedDate = DateFormat.format("dd/MM/yyyy hh:mm a", calendar).toString();//e.g 23/09/2021  08.22 AM
